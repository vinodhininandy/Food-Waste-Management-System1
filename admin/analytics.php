...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"chennai\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $chennai=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"karaikal\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $karaikal=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"pondicherry\"";
            $res5=mysqli_query($connection, $q5);
            $ro5=mysqli_fetch_assoc($res5);
            $pondicherry=$ro5['count'];
            

    ?>
var xValues = ["Male","Female"];
var xplace=["chennai","karaikal","pondicherry"];
var yplace=[<?php echo json_encode($chennai,JSON_HEX_TAG);?>,<?php echo json_encode($karaikal,JSON_HEX_TAG);?>,<?php echo json_encode($pondicherry,JSON_HEX_TAG);?>];
